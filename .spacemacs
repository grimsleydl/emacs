...
values."
  (setq-default
   ...
   '(
     ...
     (eyebrowse)
     (git)
     (html :variables scss-compile-at-save nil)
     (javascript)
     (markdown)
     (org)
     (ruby)
...
layers configuration."
  ...
  (setq org-todo-keywords
        '((sequence "TODO(t)" "NEXT(n)" "|" "DONE(d!)" "CANCELED(c@)")
          ;; (sequence "WAITING(w@/!)" "DELEGATE(-)" "DELEGATED(d@/!)" "|" "COMPLETE(x)")
          ))
...
buffer's name.
 If invoked with C-u, prompt user for `prefix' value."
  ...
  (global-set-key [f8] 'narrow-to-region-indirect)
  (global-set-key [f9] 'nuke-all-buffers)
  )
...
(custom-set-variables
 ...
 '(custom-safe-themes
   (quote
    ("dcf229d4673483cb7b38505360824fa56a0d7b52f54edbcdca98cf5059fa1662" "5d1434865473463d79ee0523c1ae60ecb731ab8d134a2e6f25c17a2b497dd459" "bffa9739ce0752a37d9b1eee78fc00ba159748f50dc328af4be661484848e476" default)))
 '(org-agenda-files (quote ("~/Dropbox/org/gtd.org" "~/Dropbox/org/me.org")))
